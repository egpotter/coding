  ...
  describe "PATCH /update" do
    context "with valid parameters" do
      ...
      it "updates the requested contract" do
        ...
        expect(contract.start_date).to eq(Date.new(2020, 05, 05))
        expect(contract.end_date).to eq(Date.new(2030, 05, 05))
        expect(contract.expiry_date).to eq(Date.new(2040, 05, 05))
      end
